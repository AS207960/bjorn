...
pub(crate) fn map_rpc_identifier(i: crate::cert_order::Identifier) -> crate::types::identifier::Identifier {
    crate::types::identifier::Identifier {
        id_type: match crate::cert_order::IdentifierType::try_from(i.id_type) {
            Err(_) => "".to_string(),
            Ok(crate::cert_order::IdentifierType::UnknownIdentifier) => "".to_string(),
            Ok(crate::cert_order::IdentifierType::DnsIdentifier) => crate::types::identifier::Type::DNS.to_string(),
            Ok(crate::cert_order::IdentifierType::IpIdentifier) => crate::types::identifier::Type::IP.to_string(),
            Ok(crate::cert_order::IdentifierType::EmailIdentifier) => crate::types::identifier::Type::Email.to_string(),
        },
        value: i.identifier,
    }
}
...
pub(crate) fn rpc_error_to_problem(err: crate::cert_order::Error) -> crate::types::error::Error {
    crate::types::error::Error {
        error_type: match crate::cert_order::ErrorType::try_from(err.error_type) {
            Err(_) => crate::types::error::Type::ServerInternal,
            Ok(crate::cert_order::ErrorType::ServerInternalError) => crate::types::error::Type::ServerInternal,
            Ok(crate::cert_order::ErrorType::AccountDoesNotExistError) => crate::types::error::Type::AccountDoesNotExist,
            Ok(crate::cert_order::ErrorType::AlreadyRevokedError) => crate::types::error::Type::AlreadyRevoked,
            Ok(crate::cert_order::ErrorType::BadCsrError) => crate::types::error::Type::BadCSR,
            Ok(crate::cert_order::ErrorType::BadNonceError) => crate::types::error::Type::BadNonce,
            Ok(crate::cert_order::ErrorType::BadPublicKeyError) => crate::types::error::Type::BadPublicKey,
            Ok(crate::cert_order::ErrorType::BadRevocationReasonError) => crate::types::error::Type::BadRevocationReason,
            Ok(crate::cert_order::ErrorType::BadSignatureAlgorithmError) => crate::types::error::Type::BadSignatureAlgorithm,
            Ok(crate::cert_order::ErrorType::CaaError) => crate::types::error::Type::CAA,
            Ok(crate::cert_order::ErrorType::CompoundError) => crate::types::error::Type::Compound,
            Ok(crate::cert_order::ErrorType::ConnectionError) => crate::types::error::Type::Connection,
            Ok(crate::cert_order::ErrorType::DnsError) => crate::types::error::Type::DNS,
            Ok(crate::cert_order::ErrorType::ExternalAccountRequiredError) => crate::types::error::Type::ExternalAccountRequired,
            Ok(crate::cert_order::ErrorType::IncorrectResponseError) => crate::types::error::Type::IncorrectResponse,
            Ok(crate::cert_order::ErrorType::InvalidContactError) => crate::types::error::Type::InvalidContact,
            Ok(crate::cert_order::ErrorType::MalformedError) => crate::types::error::Type::Malformed,
            Ok(crate::cert_order::ErrorType::OrderNotReadyError) => crate::types::error::Type::OrderNotReady,
            Ok(crate::cert_order::ErrorType::RateLimitedError) => crate::types::error::Type::RateLimited,
            Ok(crate::cert_order::ErrorType::RejectedIdentifierError) => crate::types::error::Type::RejectedIdentifier,
            Ok(crate::cert_order::ErrorType::TlsError) => crate::types::error::Type::TLS,
            Ok(crate::cert_order::ErrorType::UnauthorizedError) => crate::types::error::Type::Unauthorized,
            Ok(crate::cert_order::ErrorType::UnsupportedContactError) => crate::types::error::Type::UnsupportedContact,
            Ok(crate::cert_order::ErrorType::UnsupportedIdentifierError) => crate::types::error::Type::UnsupportedIdentifier,
            Ok(crate::cert_order::ErrorType::UserActionRequiredError) => crate::types::error::Type::UserActionRequired,
            Ok(crate::cert_order::ErrorType::AutoRenewalCanceledError) => crate::types::error::Type::AutoRenewalCanceled,
            Ok(crate::cert_order::ErrorType::AutoRenewalExpiredError) => crate::types::error::Type::AutoRenewalExpired,
            Ok(crate::cert_order::ErrorType::AutoRenewalCancellationInvalidError) => crate::types::error::Type::AutoRenewalCancellationInvalid,
            Ok(crate::cert_order::ErrorType::AutoRenewalRevocationNotSupportedError) => crate::types::error::Type::AutoRenewalRevocationNotSupported,
        },
        title: err.title,
